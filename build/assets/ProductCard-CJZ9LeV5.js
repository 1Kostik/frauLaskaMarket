import{n as g,a as y,c as a,o as v,G as w,e as i,j as e,r as P,u as k,d as D,D as $,E as M,F as b,H as z,I as E,p as I,s as j}from"./index-BYwag9Lo.js";import{M as S}from"./Modal-CmPI6vdA.js";import{h as C,P as O}from"./handleImgError-Dq8s1xJF.js";const Z=g.div`
  border-radius: 16px;
...
`,G=({onDelete:o,productId:r,title:t})=>i("div",{css:T,children:[e("h2",{children:"Ви збираєтесь видалити продукт!"}),e("p",{children:"Підтвердіть видалення продукта:"}),t&&e("span",{children:t}),e("button",{type:"button",onClick:()=>o(r),css:A,children:"Підтвердити"})]}),f=document.querySelector("#portal-root"),N=({productId:o,title:r,setIsAdvertDeleted:t})=>{const[h,l]=P.useState(!1),p=k(),c=D(),s=n=>{n.stopPropagation(),p(z(o)).then(()=>{c(`/admin/edit-advert/:${o}`)})},d=n=>{p(E(n)).then(()=>{t?t(x=>!x):c("/store")})};return e(b,{children:i(b,{children:[i("div",{css:H,children:[e("button",{type:"button",onClick:s,children:e(_,{})}),e("button",{type:"button",onClick:n=>{n.stopPropagation(),l(!0)},children:e($,{})})]}),h&&f&&M.createPortal(e(S,{setIsOpen:l,children:e(G,{onDelete:d,productId:o,title:r})}),f)]})})},K=({show:o,handleOnClickCard:r,item:t,width:h,setIsAdvertDeleted:l,type:p,widthContainer:c})=>{const{id:s,title:d}=t,u=I(j),n="imageUrls"in t&&t.imageUrls.length>0?t.imageUrls[0].img_url:"image_url"in t?t.image_url:"",x="variations"in t&&t.variations.length>0?t.variations[0].price:"price"in t?t.price:0,m="variations"in t&&t.variations.length>0?t.variations[0].discount:null;return e(Z,{widthContainer:c,show:o,onClick:()=>s!==void 0&&r&&r(s),children:i("div",{style:{display:"flex",flexDirection:"column",height:"100%"},children:[i(F,{children:[e("img",{src:n,alt:"",style:{width:`${h}`},onError:C}),p!=="popularity"&&u&&e(N,{productId:s,title:d,setIsAdvertDeleted:l})]}),i(L,{children:[e(U,{children:d}),e(O,{price:Number(x),discount:m,style_item:"storePage"})]})]})})};export{K as P,N as a};
//# sourceMappingURL=ProductCard-CJZ9LeV5.js.map
