...
`,ie=async(e,t)=>{await J(e,t)},ge=({width:e,idOrders:t,widthTagP:n,widthContainer:a,height:j,border:A,options:c,padding:L,top:z,gap:_,color:g,fontSize:U,borderRadius:F,justifyContent:R,backGround:$,isOpenSearch:y,isOpenFilter:N,disableWidth:O,setSelectedOption:h,selectedOption:x,setIsOpenModal:f,disable:S})=>{const[o,d]=i.useState(!1),[P,b]=i.useState(!1),k=i.useRef(null),C=i.useRef(!0);i.useEffect(()=>{C.current&&(h&&c&&c.length>0&&(h(c[0]),b(!0)),C.current=!1);const r=u=>{k.current&&!k.current.contains(u.target)&&d(!1)};return document.addEventListener("mousedown",r),()=>{document.removeEventListener("mousedown",r)}},[h,c]);const q=()=>{S||d(r=>!r)},B=r=>{r==="Сплачено"&&K(Number(t)),h&&(h(r),b(!0),d(!1),f&&r==="Відхилено"?f(!0):f&&f(!1)),t&&r==="Відправлено"&&ie(t,r)};return l(Y,{children:v(Z,{height:j,widthContainer:a,children:[v(G,{onClick:q,isOpen:o,padding:L,border:A,borderRadius:F,justifyContent:R,backGround:$,children:[l(W,{widthTagP:n,isOpen:o,isChange:N&&y,isOpenSearch:y,disableWidth:O,color:g,fontSize:U,children:x||""}),o&&!S?l(V,{css:re(g)}):l(Q,{css:ae(g)})]}),o&&l(T,{width:e,color:g,backGround:$,top:z,children:c&&c.map((r,u)=>v(te,{gap:_,children:[l(ne,{children:P&&x===r&&l(X,{css:ee(g)})}),l(M,{onClick:()=>B(r),color:g,children:r},u)]},r+`${u}`))})]})})};export{V as S,ge as a,ie as u};
//# sourceMappingURL=SortingItems-CxFKbst1.js.map
