import{c as i,e as p,j as e}from"./index-CIcvnpyc.js";function g(r){const t=new Date(r),n=String(t.getDate()).padStart(2,"0"),o=String(t.getMonth()+1).padStart(2,"0"),a=t.getFullYear();return`${n}.${o}.${a}`}const l=i`
  display: flex;
...
//# sourceMappingURL=StatusWarningModal-DbDPuLRC.js.map
